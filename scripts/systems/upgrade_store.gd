...
# 122 for 90s. Total 1130 across the curve is ~15 runs to max. Air lines kept that 0.4 -- the
# include chance dropped to 0.30 as three-coin lines multiplied the payout -- so this curve is
